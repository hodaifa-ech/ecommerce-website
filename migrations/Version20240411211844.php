 ...
 */
final class Version20240411211844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD email VARCHAR(255) NOT NULL, ADD tele INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP email, DROP tele');
    }
}
